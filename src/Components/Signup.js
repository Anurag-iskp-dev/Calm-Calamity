...
export const Signup = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post(`https://backend-deployemnet.onrender.com/signup`, {
                email: email,
                password: password
            }, {
                headers: {
    ...
    const handleSubmitLogin = async (event) => {
        ...
        try {
            const response = await axios.post(`https://backend-deployemnet.onrender.com/login`, {
                email: loginemail,
